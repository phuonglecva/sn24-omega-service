...
from src.services.search_service import FIVE_MINUTES
from src.utils.constants import MAX_VIDEO_LENGTH
...
def get_relevant_timestamps(query: str, yt: any, video_path: str) -> Tuple[int, int]:
    """
